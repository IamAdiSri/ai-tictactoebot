...
#		cells = self.find_valid_move_cells_optimised(board, old_move, flag)
	...
	def find_valid_move_cells_optimised(self, board, old_move, flag):
		...
		self.update_end_moves( board, allowed_cells, flag)
		best_allowed_moves = []
...
if __name__ == '__main__':
	...
	option = sys.argv[1]	
	if option == '1':
		obj1 = Player52_legacy()
		obj2 = Player52()

	elif option == '2':
		obj2 = Player52_legacy()
		obj1 = Manual_Player()
	elif option == '3':
		obj1 = Manual_Player()
		obj2 = Manual_Player()
